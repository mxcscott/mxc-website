...
NioApp = (function (NioApp, $, window) {
    "use strict";
	var $chart = $('.chart-data'), $chart_s2 = $('.chart-data-s2'), $chart_3 = $('.chart-data-3');
    ...
    NioApp.Chart.ChartJs = function () {
        ...
        if($chart_3.length > 0){
            $chart_3.each(function(){
                var $chart_data = $(this).children('li'), _canvas = $(this).data('canvas'), _canvas_border = $(this).data('border-color') ? $(this).data('border-color') : '#122272', _canvas_type = $(this).data('canvas-type');
                _canvas_type = (typeof _canvas_type==='undefined' || _canvas_type==='') ? 'doughnut' : _canvas_type;
                if(typeof _canvas!=='undefined' && _canvas !=='') {
