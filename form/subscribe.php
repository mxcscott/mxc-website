...
### Enter Your Sitename 
$sitename = 'MXC Foundation';

### Enter your email addresses: @required
$emailTO[] = array( 'email' => 'hello@mxc.org', 'name' => 'MXC Foundation - Webform' ); 
...
### Success Messages
$msg_success = "<strong>Thank you</strong> for subscribing to our weekly update.";
